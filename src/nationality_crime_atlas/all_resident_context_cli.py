"""CLI for provenance-first all-resident regional context outputs."""
...
from .all_resident_context import generate_all_resident_context_report


def _argument_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="nca-build-all-resident-context")
    parser.add_argument(
        "--catalog",
        type=Path,
    ...
    parser.add_argument(
        "--contracts",
        type=Path,
        default=Path("config/all_resident_context_contracts.json"),
    )
    parser.add_argument(
        "--output-root",
        type=Path,
        default=Path("data/processed/_all_resident_context"),
    )
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    result = generate_all_resident_context_report(
