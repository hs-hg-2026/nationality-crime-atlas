...
## 2026-09-13 公開名称と検索向けmetadataを再設計
- **何が**: 一般語中心の「全国犯罪統計地図」から「日本の犯罪統計アトラス」へ画面名を変更し、検索結果用title／description、canonical、index/follow、Open Graph metadata、sitemap、1200 × 630のOGP画像を揃えた。Pages artifact verifierは名称・metadata・canonical・sitemapの欠落や不一致を拒否する。
