...
- [x] v0.3.1として名称・検索向け表示をpush／releaseし、Actions run 34746991096、公開HTML／sitemap／OGP、live dataのbyte一致を実地確認する。
...
- publication: GitHub Pagesでv0.3.1／schema v9を公開済み。Actions run 34746991096はbuild／deployとも成功し、公開画面はHTTP 200、title・H1・metadata・sitemapがreview済み値と一致、live dashboard bundleはrepository内の公開dataとbyte-identical、SHA-256 `4219edb5c7ff75e52bae97452f4991f6e5852dd746cfca1d3dc9c4d62bd37f65`。OGP画像もreview済みassetとbyte-identicalである。
